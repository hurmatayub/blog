...
export const blog_data = [
    {
      ...
      {
        id: 3,
        title: "Exploring the World: Travel Tips for Adventurers",
        description:
          "Embark on unforgettable journeys with these essential travel tips.",
        details:
          "Traveling is one of the most enriching experiences, offering new perspectives, cultures, and memories. Whether you’re planning a weekend getaway or a long-term adventure, preparation is key. <br> Essential Travel Tips: Plan Ahead: Research your destination, book accommodations, and make an itinerary. Pack Smart: Travel light, but ensure you have essentials like a first-aid kit, weather-appropriate clothing, and travel documents. Stay Safe: Be aware of local customs and safety guidelines. Travel Insurance: Always have insurance to cover emergencies. Immerse Yourself: Try local cuisines, learn basic phrases in the local language, and embrace the culture.",
        conclusion:
          "Conclusion: Travel is not just about the destination; it’s about the journey and the experiences along the way. With the right preparation and an open mind, every trip can become a cherished memory.",
        image: blog3,
        date: Date.now(),
        category: "Travel",
        author: "Hurmat Ayub",
