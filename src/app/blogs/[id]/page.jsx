...
// This will fetch blog data server-side
export async function getServerSideProps({ params }) {
  // Find the blog post data by id
  const data = blog_data.find((blog) => blog.id === Number(params.id));

  // If the blog post does not exist, return a 404 page
  if (!data) {
    return { notFound: true };
  }

  return {
    props: { data }, // Pass the data as a prop to the page
  };
}
